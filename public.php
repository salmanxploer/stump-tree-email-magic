...
Route::get('donate', [ContactController::class, 'donate'])->name('donate');
Route::post('donate/store', [ContactController::class, 'donate_store'])->name('donate.store');
Route::get('testimonial', [ContactController::class, 'testimonial'])->name('testimonial');
Route::get('get_offer', [ContactController::class, 'get_offer'])->name('get_offer');
Route::get('get_car_model', [ContactController::class, 'get_car_model'])->name('get_car_model');
Route::get('get_car_model_sub', [ContactController::class, 'get_car_model_sub'])->name('get_car_model_sub');
Route::get('get_car_model_sub_sub', [ContactController::class, 'get_car_model_sub_sub'])->name('get_car_model_sub_sub');
Route::post('get_car_model_sub/store', [ContactController::class, 'get_car_model_sub_store'])->name('get_car_model_sub_store');
Route::get('order/checkout/{id}', [OrderController::class, 'checkout'])->name('checkouts');
Route::post('order/confirm/store', [OrderController::class, 'order_confirm'])->name('order.confirm');
Route::get('order/confirmation/{order}', [OrderController::class, 'order_confirmation'])->name('order.confirmation');
Route::get('get_offer/result', [ContactController::class, 'post_notice_zero_dollar'])->name('get_offer.result');
Route::get('get_offer/result/{offer_price}/{post_id}/{customer}', [ContactController::class, 'post_notice_with_dollar'])->name('get_offer.result.to');
Route::POST('get_offer/result/status/changes', [ContactController::class, 'post_status_with_agree'])->name('get_offer.result.status');
Route::POST('get_offer/customer/expected/price', [ContactController::class, 'customer_expected_price'])->name('customer.expected.price');
Route::POST('get_offer/customer/expected/price/second', [ContactController::class, 'no_button_click'])->name('no_button_click');
Route::get('sells', [ContactController::class, 'sells'])->name('sells');
Route::get('about', [ContactController::class, 'about'])->name('about');
Route::get('get/quotation', [ContactController::class, 'get_quotation'])->name('get.quotation');